...
import { applySolutions } from "../modules/solution-engine/index.js";
...
const solutions = applySolutions(images.journey, creative.brief, stories.storySet, images.imageBriefSet);
console.log(JSON.stringify(solutions.solutionSet, null, 2));
