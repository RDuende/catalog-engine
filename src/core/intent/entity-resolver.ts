...
const DICTIONARY: Record<AttributeType, Record<string, string[]>> = {
  audience: {
    ...
    hijo: ["hijo", "mi hijo", "chico", "muchacho"],
    hija: ["hija", "mi hija", "chica", "muchacha"],
    hermano: ["hermano", "mi hermano"],
    hermana: ["hermana", "mi hermana"],
    abuelo: ["abuelo", "abuela", "abuelos", "la abuela", "el abuelo"],
    pareja: ["pareja", "novio", "novia", "marido", "mujer", "esposo", "esposa", "mi pareja"],
    amigo: ["amigo", "amiga", "mejor amigo", "mejor amiga"],
    entrenador: ["entrenador", "entrenadora", "mister", "míster"],
  ...
  occasion: {
    ...
    graduación: ["graduacion", "graduación", "graduarse", "se gradua", "se gradúa"],
